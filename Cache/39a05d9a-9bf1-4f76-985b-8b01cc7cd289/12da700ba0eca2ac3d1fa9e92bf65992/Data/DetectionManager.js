...
// @input Asset.Prefab arrowPrefab
...
async function createDetectionPrefabAsync(detection) {
  ...
  if (script.arrowPrefab) {
      ...
      const cam = scene.getSceneObjectByName("Camera").getTransform();
    ...
    var anchor = script.anchorController.instantiate(script.sceneObject());
