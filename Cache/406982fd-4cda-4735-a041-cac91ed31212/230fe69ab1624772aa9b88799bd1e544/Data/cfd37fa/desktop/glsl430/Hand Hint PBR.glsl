...
#endif
float l9_1=clamp(Color.w,0.0,1.0);
...
{
uvec3 l9_2=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_2.x,l9_2.y,l9_2.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_3=abs(l9_0);
vec3 l9_4=l9_0/vec3(dot(l9_3,vec3(1.0)));
float l9_5=clamp(-l9_4.z,0.0,1.0);
float l9_6=l9_4.x;
float l9_7;
if (l9_6>=0.0)
{
...
uvec2 l9_11=uvec2(packHalf2x16(vec2(l9_8,0.0)),packHalf2x16(vec2(l9_9+l9_10,0.0)));
normal_and_more=uvec4(l9_11.x,l9_11.y,normal_and_more.z,normal_and_more.w);
...
{
l9_12=uint(clamp(Port_Roughness_N006,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_12|uint((receiverId%32)<<int(10u));
}
else
{
...
#endif
float l9_7=clamp(Color.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_8=max(Color.xyz,vec3(0.0));
vec4 l9_9;
#if (sc_ProjectiveShadowsCaster)
{
l9_9=vec4(l9_8,l9_7);
...
#else
{
l9_9=ngsCalculateLighting(l9_8,l9_7,l9_6,l9_1,l9_2,max(vec3(max(pow(1.0-abs(l9_5),Port_Exponent_N005),0.0)*Port_Intensity_N005),vec3(0.0)),Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
vec4 l9_10=max(l9_9,vec4(0.0));
vec4 l9_11=l9_10*vec4(Port_Value1_N010,Port_Value2_N010,Port_Value3_N010,visibility);
if (isProxyMode)
{
vec4 l9_12;
#if (sc_ProxyAlphaOne)
