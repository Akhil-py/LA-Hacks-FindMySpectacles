...
let AnchorPlacementController = class AnchorPlacementController extends BaseScriptComponent {
    ...
    attachNewObjectToAnchor(anchor) {
        ...
        let object = this.prefab.instantiate(this.td);
        const transformMatrix = anchor.toWorldFromAnchor;
        const position = new vec3(transformMatrix.column3.x, transformMatrix.column3.y, transformMatrix.column3.z);
