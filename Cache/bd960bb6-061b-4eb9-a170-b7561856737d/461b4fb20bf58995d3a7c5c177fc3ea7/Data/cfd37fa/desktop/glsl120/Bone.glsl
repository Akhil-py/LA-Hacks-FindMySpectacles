...
#endif
vec3 l9_27=max(l9_25.xyz,vec3(0.0));
vec4 l9_28;
#if (sc_ProjectiveShadowsCaster)
{
l9_28=vec4(l9_27,Port_Opacity_N006);
}
#else
{
...
vec3 l9_33=ssSRGB_to_Linear(max((baseColor*vec4(Tweak_N8)).xyz,vec3(0.0)));
vec3 l9_34;
#if (sc_SSAOEnabled)
{
...
SurfaceProperties l9_38=SurfaceProperties(l9_37,Port_Opacity_N006,l9_32,varPos,l9_0,l9_29,l9_30,l9_33,l9_34,Port_SpecularAO_N006,vec3(1.0),l9_36);
vec4 l9_39=vec4(1.0);
vec3 l9_40;
vec3 l9_41;
vec3 l9_42;
...
l9_146=vec3(0.0);
l9_145=vec3(0.0);
l9_144=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_37,vec3(Port_Opacity_N006));
l9_143=1.0;
}
#else
{
...
vec3 l9_151=l9_131*Port_SpecularAO_N006;
...
{
vec4 l9_159=l9_157;
l9_159.x=l9_156+((l9_34.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_158=l9_159;
}
#else
{
