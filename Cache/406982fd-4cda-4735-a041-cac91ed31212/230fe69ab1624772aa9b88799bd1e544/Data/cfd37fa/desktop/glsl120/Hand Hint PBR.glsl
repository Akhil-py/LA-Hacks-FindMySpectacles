...
uniform float Port_Exponent_N005;
uniform float Port_Intensity_N005;
...
#endif
float l9_4=clamp(Color.w,0.0,1.0);
...
#endif
vec3 l9_5=max(Color.xyz,vec3(0.0));
vec4 l9_6;
#if (sc_ProjectiveShadowsCaster)
{
l9_6=vec4(l9_5,l9_4);
...
#else
{
vec3 l9_7=ssSRGB_to_Linear(l9_5);
vec3 l9_8=normalize(l9_3);
vec3 l9_9=ssSRGB_to_Linear(max(vec3(max(pow(1.0-abs(dot(l9_2,l9_0)),Port_Exponent_N005),0.0)*Port_Intensity_N005),vec3(0.0)));
vec3 l9_10;
#if (sc_SSAOEnabled)
{
l9_10=evaluateSSAO(varPos);
}
#else
{
l9_10=Port_AO_N006;
...
#endif
vec3 l9_11=vec3(Port_Metallic_N006);
vec3 l9_12=mix(vec3(0.039999999),l9_7*Port_Metallic_N006,l9_11);
vec3 l9_13=mix(l9_7*(1.0-Port_Metallic_N006),vec3(0.0),l9_11);
SurfaceProperties l9_14=SurfaceProperties(l9_13,l9_4,l9_8,varPos,l9_1,Port_Metallic_N006,Port_Roughness_N006,l9_9,l9_10,Port_SpecularAO_N006,vec3(1.0),l9_12);
vec4 l9_15=vec4(1.0);
vec3 l9_16;
vec3 l9_17;
vec3 l9_18;
...
{
LightingComponents l9_35=accumulateLight(LightingComponents(l9_23,l9_24,l9_29,l9_28,l9_26,l9_25),LightProperties(sc_DirectionalLights[l9_34].direction,sc_DirectionalLights[l9_34].color.xyz,sc_DirectionalLights[l9_34].color.w*l9_15[(l9_27<3) ? l9_27 : 3]),l9_14,l9_1);
l9_29=l9_35.indirectDiffuse;
l9_28=l9_35.indirectSpecular;
l9_27++;
l9_26=l9_35.emitted;
...
{
vec3 l9_54=sc_PointLights[l9_52].position-varPos;
...
l9_45=l9_53+1;
LightingComponents l9_60=accumulateLight(LightingComponents(l9_39,l9_40,l9_44,l9_43,l9_42,l9_41),LightProperties(l9_55,sc_PointLights[l9_52].color.xyz,l9_59),l9_14,l9_1);
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_64=abs(varShadowTex-vec2(0.5));
vec4 l9_65=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_64.x,l9_64.y),0.5);
l9_63=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_65.xyz,vec3(sc_ShadowColor.w)),vec3(l9_65.w*sc_ShadowDensity));
}
#else
{
l9_63=vec3(1.0);
...
{
vec2 l9_67=calcPanoramicTexCoordsFromDir(l9_8,sc_EnvmapRotation.y);
vec4 l9_68;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_69=calcSeamlessPanoramicUvsForSampling(l9_67,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_69=l9_67;
...
#endif
l9_68=sc_EnvmapSpecularSampleViewIndexBias(l9_69,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_70;
...
{
vec2 l9_71=calcSeamlessPanoramicUvsForSampling(l9_67,sc_EnvmapDiffuseSize.xy,0.0);
int l9_72;
...
#endif
l9_70=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_71,sc_EnvmapDiffuseLayout,l9_72).xy,-13.0);
}
#else
{
l9_70=sc_EnvmapSpecularSampleViewIndexBias(l9_67,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_68=l9_70;
}
#endif
l9_66=(l9_68.xyz*(1.0/l9_68.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_73;
...
float l9_76=l9_74.y;
float l9_77=l9_74.z;
l9_73=(((((((sc_Sh[8]*0.42904299)*((l9_75*l9_75)-(l9_76*l9_76)))+((sc_Sh[6]*0.74312502)*(l9_77*l9_77)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_75*l9_76))+(sc_Sh[7]*(l9_75*l9_77)))+(sc_Sh[5]*(l9_76*l9_77)))*0.85808599))+((((sc_Sh[3]*l9_75)+(sc_Sh[1]*l9_76))+(sc_Sh[2]*l9_77))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_73=vec3(0.0);
...
{
l9_79=l9_66+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_80=l9_66;
l9_80.x=l9_66.x+(1e-06*sc_AmbientLights[0].color.x);
l9_79=l9_80;
}
#endif
l9_78=l9_79;
...
{
l9_82=l9_78+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_83=l9_78;
l9_83.x=l9_78.x+(1e-06*sc_AmbientLights[1].color.x);
l9_82=l9_83;
}
#endif
l9_81=l9_82;
...
{
l9_85=l9_81+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_86=l9_81;
l9_86.x=l9_81.x+(1e-06*sc_AmbientLights[2].color.x);
l9_85=l9_86;
}
#endif
l9_84=l9_85;
...
{
vec3 l9_88;
l9_88=sc_LightEstimationData.ambientLight;
vec3 l9_89;
int l9_90=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_90<sc_LightEstimationSGCount)
{
float l9_91=dot(sc_LightEstimationData.sg[l9_90].axis,l9_8);
float l9_92=exp(-sc_LightEstimationData.sg[l9_90].sharpness);
float l9_93=l9_92*l9_92;
float l9_94=1.0/sc_LightEstimationData.sg[l9_90].sharpness;
float l9_95=(1.0+(2.0*l9_93))-l9_94;
float l9_96=sqrt(1.0-l9_95);
float l9_97=0.36000001*l9_91;
float l9_98=(1.0/(4.0*0.36000001))*l9_96;
float l9_99=l9_97+l9_98;
float l9_100;
if (step(abs(l9_97),l9_98)>0.5)
{
l9_100=(l9_99*l9_99)/l9_96;
}
else
{
l9_100=clamp(l9_91,0.0,1.0);
}
l9_89=l9_88+((((sc_LightEstimationData.sg[l9_90].color/vec3(sc_LightEstimationData.sg[l9_90].sharpness))*6.2831855)*((l9_95*l9_100)+(((l9_92-l9_93)*l9_94)-l9_93)))/vec3(3.1415927));
l9_88=l9_89;
l9_90++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_102=clamp(pow(Port_Roughness_N006,0.66666669),0.0,1.0)*5.0;
vec2 l9_103=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_8,reflect(l9_2,l9_8),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_104;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_105=floor(l9_102);
float l9_106=ceil(l9_102);
l9_104=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_103,sc_EnvmapSpecularSize.xy,l9_105),sc_EnvmapSpecularGetStereoViewIndex(),l9_105),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_103,sc_EnvmapSpecularSize.xy,l9_106),sc_EnvmapSpecularGetStereoViewIndex(),l9_106),vec4(l9_102-l9_105));
}
#else
{
l9_104=sc_EnvmapSpecularSampleViewIndexLevel(l9_103,sc_EnvmapSpecularGetStereoViewIndex(),l9_102);
}
#endif
l9_101=vec3(0.0)+((((l9_104.xyz*(1.0/l9_104.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_14,abs(dot(l9_8,l9_1))));
}
#else
{
l9_101=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_108=clamp(Port_Roughness_N006*Port_Roughness_N006,0.0099999998,1.0);
vec3 l9_109;
l9_109=sc_LightEstimationData.ambientLight*l9_12;
int l9_110=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_112=reflect(l9_2,l9_8);
float l9_113=dot(l9_8,l9_1);
float l9_114=(2.0/l9_111)/(4.0*max(l9_113,9.9999997e-05));
float l9_115=length((l9_112*l9_114)+(sc_LightEstimationData.sg[l9_110].axis*sc_LightEstimationData.sg[l9_110].sharpness));
float l9_116=clamp(dot(l9_8,l9_112),0.0,1.0);
float l9_117=clamp(l9_113,0.0,1.0);
float l9_118=1.0-l9_111;
l9_109+=((((((((vec3(1.0/(3.1415927*l9_111))*exp((l9_115-l9_114)-sc_LightEstimationData.sg[l9_110].sharpness))*sc_LightEstimationData.sg[l9_110].color)*6.2831855)*(1.0-exp((-2.0)*l9_115)))/vec3(l9_115))*((1.0/(l9_116+sqrt(l9_111+((l9_118*l9_116)*l9_116))))*(1.0/(l9_117+sqrt(l9_111+((l9_118*l9_117)*l9_117))))))*(l9_12+((vec3(1.0)-l9_12)*pow(1.0-clamp(dot(l9_112,normalize(l9_112+l9_1)),0.0,1.0),5.0))))*l9_116);
l9_110++;
continue;
}
else
...
l9_122=vec3(0.0);
l9_121=vec3(0.0);
l9_120=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_13,vec3(l9_4));
l9_119=1.0;
}
#else
{
...
#endif
vec3 l9_124=l9_121*l9_10;
vec3 l9_125=l9_122+l9_124;
vec3 l9_126=l9_13*l9_125;
vec3 l9_127=l9_107*Port_SpecularAO_N006;
vec3 l9_128=l9_61+l9_127;
vec3 l9_129;
if (l9_123)
{
...
vec3 l9_131=(l9_130+l9_9)+l9_120;
float l9_132=l9_131.x;
vec4 l9_133=vec4(l9_132,l9_131.yz,l9_119);
vec4 l9_134;
#if (sc_IsEditor)
{
vec4 l9_135=l9_133;
l9_135.x=l9_132+((l9_10.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_134=l9_135;
}
#else
{
...
{
vec3 l9_137=l9_134.xyz*1.8;
vec3 l9_138=(l9_134.xyz*(l9_137+vec3(1.4)))/((l9_134.xyz*(l9_137+vec3(0.5)))+vec3(1.5));
l9_136=vec4(l9_138.x,l9_138.y,l9_138.z,l9_134.w);
}
#else
{
l9_136=l9_134;
...
#endif
vec3 l9_139=vec3(linearToSrgb(l9_136.x),linearToSrgb(l9_136.y),linearToSrgb(l9_136.z));
l9_6=vec4(l9_139.x,l9_139.y,l9_139.z,l9_136.w);
}
#endif
vec4 l9_140=max(l9_6,vec4(0.0));
vec4 l9_141=l9_140*vec4(Port_Value1_N010,Port_Value2_N010,Port_Value3_N010,visibility);
vec4 l9_142;
#if (sc_ProjectiveShadowsCaster)
{
float l9_143;
