...
//texture texture2DArray OpacityTexArrSC 0:32:0:21
...
#if (Tweak_N6)
{
vec2 l9_3=l9_0-Port_Center_N001;
vec2 l9_4=(l9_3*vec2(uvScale))+Port_Center_N001;
vec4 l9_5;
#if (OpacityTexLayout==2)
{
float l9_6=l9_4.x;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).x);
float l9_7=l9_6;
float l9_8=l9_4.y;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).y);
float l9_9=l9_8;
vec2 l9_10;
float l9_11;
...
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).x==3;
}
#else
{
...
float l9_13=l9_7;
float l9_14=1.0;
sc_ClampUV(l9_13,OpacityTexUvMinMax.x,OpacityTexUvMinMax.z,l9_12,l9_14);
float l9_15=l9_13;
float l9_16=l9_14;
bool l9_17;
#if (SC_USE_CLAMP_TO_BORDER_OpacityTex)
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).y==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_OpacityTex)!=0);
}
#endif
float l9_18=l9_9;
float l9_19=l9_16;
sc_ClampUV(l9_18,OpacityTexUvMinMax.y,OpacityTexUvMinMax.w,l9_17,l9_19);
l9_11=l9_19;
...
#endif
vec2 l9_20=sc_TransformUV(l9_10,(int(SC_USE_UV_TRANSFORM_OpacityTex)!=0),OpacityTexTransform);
float l9_21=l9_20.x;
float l9_22=l9_11;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_OpacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_OpacityTex)!=0)),l9_22);
float l9_23=l9_20.y;
float l9_24=l9_22;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_OpacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_OpacityTex)!=0)),l9_24);
float l9_25=l9_24;
vec3 l9_26=sc_SamplingCoordsViewToGlobal(vec2(l9_21,l9_23),OpacityTexLayout,OpacityTexGetStereoViewIndex());
vec4 l9_27=texture(OpacityTexArrSC,l9_26,0.0);
vec4 l9_28;
#if (SC_USE_CLAMP_TO_BORDER_OpacityTex)
{
l9_28=mix(OpacityTexBorderColor,l9_27,vec4(l9_25));
}
#else
{
l9_28=l9_27;
...
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_OpacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_OpacityTex)!=0)),l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_OpacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_OpacityTex)!=0)),l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),OpacityTexLayout,OpacityTexGetStereoViewIndex());
vec4 l9_50=texture(OpacityTex,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_OpacityTex)
{
...
#endif
vec4 l9_52=vec4(Color.x,Color.y,Color.z,vec4(0.0).w);
l9_52.w=l9_2;
...
#endif
sc_writeFragData0(max(l9_53,vec4(0.0)));
return;
}
vec4 l9_55;
...
{
l9_58=clamp(dot(l9_52.xyz,vec3(l9_2)),0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_60=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*l9_2;
}
#else
{
float l9_61;
...
{
l9_61=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*l9_2;
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_63;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_64=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_65;
...
{
l9_65=dot(l9_52.xyz,vec3(0.33333001))*l9_2;
}
#else
{
float l9_66;
...
#endif
vec3 l9_79=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_52.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_81=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_82;
...
#endif
l9_82=vec4(l9_52.xyz*l9_83,l9_83);
}
#else
{
l9_82=l9_52;
