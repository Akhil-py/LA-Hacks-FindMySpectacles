...
//sampler sampler OpacityTexSmpSC 0:16
...
//texture texture2D OpacityTex 0:0:0:16
...
#if (Tweak_N6)
{
vec2 l9_1=((varPackedTex.xy-Port_Center_N001)*vec2(uvScale))+Port_Center_N001;
int l9_2;
...
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_OpacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_OpacityTex)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_OpacityTex,SC_SOFTWARE_WRAP_MODE_V_OpacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_OpacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_OpacityTex)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),OpacityTexLayout,l9_2);
vec4 l9_24=texture2D(OpacityTex,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_OpacityTex)
{
...
#endif
vec4 l9_26=vec4(Color.x,Color.y,Color.z,vec4(0.0).w);
l9_26.w=l9_0;
...
{
l9_30=clamp(dot(l9_26.xyz,vec3(l9_0)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*l9_0;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*l9_0;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_0;
}
#else
{
float l9_35;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_0;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_26.xyz,vec3(0.33333001))*l9_0;
}
#else
{
float l9_38;
...
#endif
vec3 l9_50=mix(l9_48.xyz,definedBlend(l9_48.xyz,l9_26.xyz).xyz,vec3(l9_0));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_52=vec4(mix(vec3(1.0),l9_26.xyz,vec3(l9_0)),l9_0);
}
#else
{
vec4 l9_53;
